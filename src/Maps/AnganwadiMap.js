...
import $ from 'jquery';
import './ReactMap.css'
import data from '../cookedFiles/AnganwadiDetails.json';
class MapContainerA extends Component {
  state = {
    loc: [0, 0]
  };
  componentDidMount() {
  ...
  initMap = () => {
    ...
    Object.entries(data).forEach(([key, val]) => {
      var contentString = ("<p>" + val['PhoneNumber'] + "</p>" + "<p>" + val['Email'] + ",</p>" + "<p>" + val['City'] + ",</p>" + "<p>" + val['State'] + ",</p>" + "<p>" + val['District'] + "</p>" + "India");
